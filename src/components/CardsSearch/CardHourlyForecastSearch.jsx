...
import { getTodayForecastByCity } from "../../api/weatherLocation";
import { useState, useEffect } from "react";

function CardHourlyForecastSearch() {
    ...
    useEffect(() => {
        if(nomeDaCidade) {
        getTodayForecastByCity(nomeDaCidade)
...
export default CardHourlyForecastSearch